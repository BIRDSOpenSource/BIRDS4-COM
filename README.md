...
# BIRDS4-COM
 Documentation for the communications board used in the BIRDS4 Satellite
...
├── .gitattributes
├── Addnics COM ICD_e_RevC_211011.pdf
├── Addnics COM ICD_j_RevC_211011.pdf
├── BIRDS Compatible Radiometrix HX1.pdf
├── LICENSE
└── README.md
